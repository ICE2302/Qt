...
//设置数据库存放路径
bool mysqls::setDbDir(QString dirPath)
{
    QDir dir(dirPath);
    if(dir.exists())
    {
...
//打开连接
bool mysqls::reOpenSql(QString dbName)
{
...
//生成一个db文件
bool mysqls::creatDbFile(QString dbName)
{
    QString fileName = (dbDir + "/"+dbName + ".db");
    QFile file(fileName);
...
//错误打印
void mysqls::errorSql(QString sql)
{
    errorSqlText = sql;
    //QString("数据库执行错误：%1 ")+sql.toUtf8().constData();
}
//获取错误的数据库语句
QString mysqls::getErrorSql()
{
    if(databaseName.isEmpty())
    {
...
//执行sql语句，不获取结果
bool mysqls::queryExec(QString dbName,QString queryStr)
{
    if(databaseName.isEmpty())
    {
        if(!reOpenSql(dbName))
...
//执行sql语句，并获取结果
bool mysqls::queryExec(QString dbName,QString queryStr,QList<QHash<QString,QString>> &data)
{
    data.clear();
    if(databaseName.isEmpty())
    {
...
//获取数据
bool mysqls::getData(QString dbName,QString tableName,QHash<QString,QString> &data,QString sqlWhere)
{
    data.clear();
...
//获取数据
bool mysqls::getData(QString dbName,QString tableName,QList<QHash<QString,QString>> &data,QString sqlWhere)
{
...
//获取数据
bool mysqls::getData(QString dbName,QString tableName,QHash<QString,QString> columndata,QList<QHash<QString,QString>> &data,QString sqlWhere)
{
    QString colunmStr;
...
//增加
bool mysqls::addData(QString dbName,QString tableName,QHash<QString,QString> data)
{
    if(data.isEmpty())
        return false;
...
//删除
bool mysqls::delData(QString dbName, QString tableName, QString sqlWhere)
{
...
//修改
bool mysqls::updateData(QString dbName,QString tableName,QHash<QString,QString> data,QString sqlWhere)
{
...
//执行sql语句，不获取结果
bool mysqls::queryExec(QString sqlStr)
{
    if(databaseName.isEmpty())
        return false;
...
//执行sql语句，并获取结果
bool mysqls::queryExec(QString sqlStr,QList<QHash<QString,QString>> &data)
{
    if(databaseName.isEmpty())
        return false;
...
//获取数据
bool mysqls::getData(QString tableName,QHash<QString,QString> &data,QString sqlWhere)
{
    if(databaseName.isEmpty())
        return false;
...
//获取数据
bool mysqls::getData(QString table,QList<QHash<QString,QString>> &data,QString sqlWhere)
{
    if(databaseName.isEmpty())
        return false;
...
//获取数据
bool mysqls::getData(QString tableName,QHash<QString,QString> columndata,QList<QHash<QString,QString>> &data,QString sqlWhere)
{
    if(databaseName.isEmpty())
        return false;
...
//增加
bool mysqls::addData(QString tableName,QHash<QString,QString> data)
{
    if(databaseName.isEmpty())
        return false;
...
//删除
bool mysqls::delData(QString tableName,QString sqlWhere)
{
    if(databaseName.isEmpty())
        return false;
...
//修改
bool mysqls::updateData(QString tableName,QHash<QString,QString> data,QString sqlWhere)
{
    if(databaseName.isEmpty())
        return false;
